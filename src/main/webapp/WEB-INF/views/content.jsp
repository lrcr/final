...
<div class="row">
	<c:forEach items="${broadcast}" var="dto">
		<!--sample1-->
		<div class="col-sm-2 col-md-2 tv-detail" id="${dto.no}th-store">
			<div class="thumbnail">
				...
				<div class="caption">
					...
					<p>
						<a href="#" class="btn btn-primary" data-toggle="modal"
							data-target="#storedetail${dto.no }">상세정보 </a>
				</div>
			</div>
		</div>
	</c:forEach>
...
<c:forEach items="${broadcast}" var="dto">
	...
	<div id="storedetail${dto.no }" class="modal fade" tabindex="-1"
				...
				<div class="modal-body ">
					<form class="form-horizontal">
						<fieldset>
										...
										<thead>
											<tr>
												...
												<th><a class="btn btn-primary"
													href="javascript:viewmap(${dto.loc },${dto.no });">지도보기</a></th>
												<th><a class="btn btn-primary" href="${dto.site}">홈페이지</a></th>
											</tr>
										</thead>
									</table>
								</div>
							...
							<div class="col-lg-12">
								<strong class="choice col-lg-6">제 점수는요</strong> <span
									class="star-rating col-lg-6"> <input type="radio"
